...
def _add_detection_config(arg_parser):
    ...
    arg_parser.add_argument("--cfg", dest='cfg',
                            help="Config file", default="utils/detection/yolo/cfg/yolov3-tiny-football.cfg", type=str)
    arg_parser.add_argument("--weights", dest='weights', help="weightsfile",
                            default="utils/detection/yolo/weights/yolov3-tiny-football.weights", type=str)
    arg_parser.add_argument("--names", dest='names', help="classes file",
                            default="utils/detection/yolo/cfg/football.names", type=str)
